...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen gradient-hero flex items-center justify-center p-4" dir="rtl">
      ...
      <div className="absolute bottom-0 right-0 w-96 h-96 rounded-full bg-white/5 translate-x-1/2 translate-y-1/2 pointer-events-none" />
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-card rounded-3xl shadow-2xl p-8 border border-border/20">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="w-16 h-16 rounded-2xl gradient-primary flex items-center justify-center shadow-purple mb-4">
        ...
        <p className="text-center text-white/60 text-xs mt-4">
          هذه الصفحة مخصصة لمدراء المنصة فقط
        </p>
      </div>
    </div>
  );
